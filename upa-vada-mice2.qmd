...
```{r}
#| ecbo: false
#| final data are from day 10 harvest
...
dat |> 
  ...
  labs( x = "Treatment Group",
        ...
        caption = "Comparisons with Student's t test", 
        title = "Colon Weight by Treatment Group")+ 
  ggsignif::geom_signif(comparisons = list(
    c(1,2), c(1,3), c(2,3), c(3,4), c(4,5), c(1,4),
    c(1,5)),
    test = "t.test",
    step_increase = 0.1)
```
...
dat |> 
  ...
  labs( x = "Treatment Group",
        ...
        caption = "Too many ties to calculate several p values",

...
dat |> 
  ...
  annotate("text", x = 3.44, y = 28.3, label = "29.5", size = 5, color ="red") +
  annotate("text", x = 4.44, y = 24.0, label = "24.0", size = 5, color ="red") +
 theme(legend.position = "none") +
  scale_fill_manual(values = c("gray90", "gray50", "red", "orange", "green"))
  
ggsave(here("images/colon_ratio.png"), width = 8, height = 6)
...
fitc2 |> 
  ...
  annotate("text", x = 4.44, y = 7.23, label = "7.23", size = 5, color ="red") + theme(legend.position = "none") +
  scale_fill_manual(values = c("gray90", "gray50", "red", "orange", "green"))
  
ggsave(here("images/fitc.png"), width = 8, height = 6)
...
dat |> 
  ...
  labs( x = "Treatment Group",
        ...
        caption = "Pairwise Comparisons using Student's t Test\nToo many ties to calculate several p values",
...
histo2 |>
  ...
  annotate("text", x = 4.49, y = 3.6, label = "3.6", size = 5, color = "red") + theme(legend.position = "none") +
  scale_fill_manual(values = c("gray90", "gray50", "red", "orange", "green"))
...
histo2 |>
  ...
  theme_linedraw(base_size = 16, base_family = "Arial") +
  annotate("text", x = 2.49, y = 5.4, label = "5.4", size = 5, color = "red") +
  annotate("text", x = 3.49, y = 4.5, label = "4.5", size = 5, color = "red") +
  annotate("text", x = 4.49, y = 2.6, label = "2.6", size = 5, color = "red") + theme(legend.position = "none") +
  scale_fill_manual(values = c("gray90", "gray50", "red", "orange", "green"))

ggsave(here("images/tot_histo.png"), width = 8, height = 6)

...
fitc2 |> 
  ...
  scale_x_discrete(labels = label_wrap(6)) +
  theme_linedraw(base_size = 16, base_family = "Arial") +
  annotate("text", x = 2.29, y = 18.3, label = "18.3", size = 5, color ="red") +
  annotate("text", x = 3.29, y = 13.1, label = "13.1", size = 5, color ="red") +
  annotate("text", x = 4.29, y = 7.23, label = "7.23", size = 5, color ="red") + theme(legend.position = "none") +
  scale_fill_manual(values = c("gray90", "gray50", "red", "orange", "green"))
